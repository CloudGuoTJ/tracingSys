...
public class HttpRequestUtil {
    ...
    /**
     * 向指定 URL 发送POST方法的请求        发送请求的 URL
     * 请求参数，请求参数应该是 name1=value1&name2=value2 的形式。返回所代表远程资源的响应结果
     * @param url
     *            
     * @param param
     * 
	...
	/**
	 * 发送https请求
	 * requestUrl 请求地址 | requestMethod 请求方式（GET、POST）| outputStr 提交数据 | 返回服务器响应的信息
	 * @param requestUrl 
	 * @param requestMethod 
	 * @param outputStr 
	 * @return 
	 ...
	 * 
	 * 发送post请求  到微信 
	 * url 请求地址 | data 提交数据 xml格式 | 返回服务器响应的信息
	 * 
	 * @param url
	 * @param data
	 * @return
