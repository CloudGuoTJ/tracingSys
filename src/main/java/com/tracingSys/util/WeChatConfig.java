...
public class WeChatConfig {
	...
	public static final String YUER_HTML = "redirect:https://ym-a.top/wx/func/yuer/yuer.html";
	...
	/**-------------------------------------cloud Update at 2018-1-16,for WD updates!--------------------------------------------------------------------***/
	//微店升级接口服务型接口连接:
	
	public final static String WD_GET_CODE = "https://oauth.open.weidian.com/oauth2/authorize?appkey={appkey}&redirect_uri={redirect_uri}&response_type=code&state={state}";
	
	// 服务型用户获取ACCESS_TOKEN升级接口连接
	public final static String WD_GET_TOKEN_BY_CODE = "https://oauth.open.weidian.com/oauth2/access_token?appkey={appkey}&secret={secret}&code={code}&grant_type=authorization_code";
	//获取token的接口,
	public final static String WD_REDIRECT_URI = "https://ym-a.top/cloud_code/WD/getWdToken.do";
	
	//更新微店TOKEN信息接口
	public final static String WD_GET_CODE_FOR_TOKEN_REFRESH = "https://oauth.open.weidian.com/oauth2/refresh_token?appkey={appkey}&grant_type=refresh_token&refresh_token={refresh_token}";
